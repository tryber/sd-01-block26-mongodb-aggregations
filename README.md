...
Agora, encontre a intersecção dos filmes nas duas listas de `top 10` do desafio 8, exibindo a **quantidade** de filmes em comum entre elas.

O resultado da sua query deve ter o seguinte formato:

```javascript
{ "filmesEmComum" : <numero_de_filmes> }
```

##### Desafio 10

Agora que sabemos quantos filmes há em comum nas duas listas de maiores notas, retorne um documento contendo o nome do filme, ano de lançamento e as notas no IMDB e no metacritic. Chame esses campos de `nome`, `anoLancamento`, `notaImdb` e `notaMetacritica`, respectivamente.
...
{
  "nome" : [ /* Nomes */ ],
  "anoLancamento" : [ /* Anos de lançamento */ ],
  "notaImdb" : [ /* Notas IMDB */ ],
  "notaMetacritic" : [ /* Notas Metacritic */ ]
}
```
...
A coleção `air_airlines` tem o seguinte _schema_:

```javascript
{
  "_id" : ObjectId("56e9b497732b6122f8790295"),
  "airline" : 22,
  "name" : "Aloha Airlines",
  "alias" : "AQ",
  "iata" : "AAH",
...
A coleção `air_routes` tem o seguinte _schema_:

```javascript
{
  "_id" : ObjectId("56e9b39b732b6122f877fa62"),
  "airline" : {
    "id" : 1654,
    "name" : "Cargoitalia",
    "alias" : "2G",
...
E, por fim, a coleção `air_alliances` armazena as companhias aéreas e suas parceiras com o seguinte _schema_:
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-01-block26-mongodb-aggregations.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-01-block26-mongodb-aggregations`
